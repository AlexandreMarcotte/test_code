...
area.addDock(d2, 'left')     ## place d2 at right edge of dock area
area.addDock(d3, 'left' )## place d3 at bottom edge of d1
area.addDock(d4, 'left')     ## place d4 at right edge of dock area
